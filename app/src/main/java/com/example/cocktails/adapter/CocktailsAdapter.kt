...
class CocktailsAdapter(val listener: clickListener): ListAdapter<CocktailModel,CocktailsAdapter.ViewHolder>(CocktailsDiffUtil()) {
    ...
    fun filterList(filterllist: ArrayList<CocktailModel>) {
        list = filterllist
